...
public class AdvancedSifterScreen extends HandledScreen<AdvancedSifterScreenHandler> {
    
    private static final Identifier TEXTURE = MilkevsOreMiners.id("textures/gui/advanced_sifter.png");
    
    public AdvancedSifterScreen(AdvancedSifterScreenHandler screenHandler, PlayerInventory playerInventory, Text text) {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        //draw power bar
        AdvancedSifterBlockEntity blockEntity = this.handler.getBlockEntity();
