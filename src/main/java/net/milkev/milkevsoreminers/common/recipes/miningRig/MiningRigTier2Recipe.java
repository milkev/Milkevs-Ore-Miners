...
public class MiningRigTier2Recipe implements Recipe<MilkevsSingleRecipeInput.Single> {
    ...
    public MiningRigTier2Recipe(Identifier id, ItemStack[] output, int[] weight, int powerCost, int powerUsageSpeed) {
        this.output = output;
        this.weight = weight;
        this.ID = id;
    ...
    public static class Type implements RecipeType<MiningRigTier2Recipe> {
        private Type() {}
        public static final Type INSTANCE = new Type();
        public static final String ID = "miningrig_tier_2";
    }
    @Override
